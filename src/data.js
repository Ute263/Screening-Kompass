...
export const PRINT_SHEETS = [
  ...
  sheet(41, "W1", "Visuelle Wahrnehmung im Schulalltag", "Aufgaben- und Beobachtungsbogen", ["W1"]),
  sheet(42, "W2", "Visuelle Verarbeitung - kurze Aufgaben", "Aufgaben- und Beobachtungsbogen", ["W2"]),
  sheet(43, "W3", "Auditive Verarbeitung", "Aufgaben- und Beobachtungsbogen", ["W3"]),
  sheet(44, "W4", "Bewegung, Koordination und Körpermittellinie", "Aufgaben- und Beobachtungsbogen", ["W4"]),
  sheet(45, "W5", "Fein- und Visuomotorik", "Aufgaben- und Beobachtungsbogen", ["W5"]),
  sheet(22, "L1", "Denken und Lernen", "Aufgaben- und Beobachtungsbogen", ["L1"]),
  sheet(23, "L2", "Kurz üben und erneut ausprobieren", "Aufgaben- und Beobachtungsbogen", ["L2"]),
  sheet(24, "D1", "Laute, Silben und Buchstaben", "Aufgaben- und Beobachtungsbogen", ["D1"]),
  sheet(25, "D2", "Lesen - Grundlagen", "Aufgaben- und Beobachtungsbogen", ["D2"]),
  sheet(26, "D3", "Schreiben und Verschriften", "Aufgaben- und Beobachtungsbogen", ["D3"]),
  sheet(27, "D4", "Sprachverstehen und Erzählen", "Aufgaben- und Beobachtungsbogen", ["D4"]),
  sheet(28, "D5", "Deutsch: Lesen erweitert", "Aufgaben- und Beobachtungsbogen", ["D5"]),
  sheet(29, "D6", "Lesematerial: Wörter und Pseudowörter", "Lesematerial", ["D2", "D5"]),
  sheet(30, "D7", "Lesetext A: Der Schlüssel im Garten", "Lesematerial", ["D5"]),
  sheet(31, "D8", "Lesetext B: Ein Plan für den Schulgarten", "Lesematerial", ["D5"]),
  sheet(32, "D9", "Schreiben und Rechtschreibung erweitert", "Aufgaben- und Beobachtungsbogen", ["D9"]),
  sheet(33, "D10", "Schreibprobe: eigener Text", "Arbeitsmaterial", ["D9"]),
  sheet(34, "M1", "Mengen und Zählen", "Aufgaben- und Beobachtungsbogen", ["M1"]),
  sheet(35, "M2", "Ziffern, Zahlenraum und Stellenwert", "Aufgaben- und Beobachtungsbogen", ["M2"]),
  sheet(36, "M3", "Zerlegen und Rechnen", "Aufgaben- und Beobachtungsbogen", ["M3"]),
  sheet(37, "M4", "Sachrechnen, Muster und Größen", "Aufgaben- und Beobachtungsbogen", ["M4"]),
  sheet(38, "M5", "Mathematik: Zahlraum bis 100", "Aufgaben- und Beobachtungsbogen", ["M5"]),
  sheet(39, "M6", "Mathematik: Rechnen bis 100", "Aufgaben- und Beobachtungsbogen", ["M5"]),
  sheet(40, "M7", "Mathematik: weiterführende Anwendung", "Aufgaben- und Beobachtungsbogen", ["M5"]),
  sheet(7, "V1", "Ausgangsbeobachtung über fünf Tage", "Aufgaben- und Beobachtungsbogen", ["V1"]),
  sheet(8, "V2", "Lern- und Arbeitsverhalten", "Aufgaben- und Beobachtungsbogen", ["V2"]),
  sheet(9, "V3", "Hilfe annehmen und Neues lernen", "Aufgaben- und Beobachtungsbogen", ["V3"]),
  sheet(10, "V4", "Sozial-emotionale Beobachtung", "Aufgaben- und Beobachtungsbogen", ["V4"]),
  sheet(11, "V5", "Ereignisbogen bei Blockieren oder Aggression", "Zusatzbogen", ["V4"]),
  sheet(12, "V6", "Regulation in verschiedenen Situationen", "Aufgaben- und Beobachtungsbogen", ["V6"]),
  sheet(18, "S1", "Aussprache, Stimme und Redefluss", "Aufgaben- und Beobachtungsbogen", ["S1"]),
  sheet(46, "W6", "Taktil-kinästhetische Wahrnehmung", "Aufgaben- und Beobachtungsbogen", ["W6"]),
  sheet(56, "Z1", "Auswertungshilfe Deutsch", "Lösung und Auswertung", ["D1", "D2", "D3", "D4", "D5", "D9"], false),
  sheet(57, "Z2", "Auswertungshilfe Mathematik", "Lösung und Auswertung", ["M1", "M2", "M3", "M4", "M5"], false),
  sheet(59, "Material A", "Formkarten", "Ausschneidematerial", ["W2", "L1", "L2"]),
  sheet(60, "Material B", "Mengenkarten", "Ausschneidematerial", ["M1", "M3"]),
  sheet(61, "Material C", "Zahlenkarten", "Ausschneidematerial", ["M1", "M2", "M3"]),
  sheet(62, "Material D", "Musterfolgen", "Ausschneidematerial", ["W2", "L1", "L2", "M4"]),
  sheet(63, "Material E", "Buchstabenkarten", "Ausschneidematerial", ["D1"]),
  sheet(64, "Material F", "Schreibprobe Grundlagen", "Arbeitsmaterial", ["W5", "D3"]),
  sheet(65, "Material G", "Lesekarten Grundlagen", "Lesematerial", ["D1", "D2"]),
  sheet(66, "Material H", "Lesesätze Grundlagen", "Lesematerial", ["D2"]),
  sheet(67, "Material I", "Visuelles Suchblatt", "Arbeitsmaterial", ["W2"])
];
